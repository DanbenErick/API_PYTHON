    ...
    for resultado in resultados:
        ...
        if codigo_carrera != carrera_actual or modalidad != modalidad_actual:
            ...
            header = [
                    ...
                    ["AREA DE:", Paragraph(f"<b>{resultado['AREA']}</b>", styleSheet["BodyText"])],
        ...
        if resultado['DNI'] not in registros_vistos:
            ...
            if resultado['ESTADO'] == "INGRESO":
                ...
                data.append([
                    ...
                    Paragraph(f"<font size=12><b>{upper(resultado['NOMBRE_COMPLETO'])}</b></font>", styleSheet["BodyText"]), 
...
def generar_pdf_resultados_final_examen_cepre(id_proceso, cordinador):
    image_no_ingreso = Image('imagenes/logo-undac.png', width=0.3*inch, height=0.3*inch)
    # url_host_api = 'http://143.198.105.92:3500'
    # url_host_api = 'http://172.19.144.1:3500'
    # url_host_api = 'http://172.19.144.1:3500'
