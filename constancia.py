...
def generar_constancia_por_estudiante(proceso, dni):
  ...
  data = [
      ...
      ['DNI:', datos['DNI']],
      ['Codigo:', datos['CODIGO_MATRICULA']],
      ['Sede: ', datos['SEDE_FACULTAD']],
      ['Direccion: ', datos['DIRECCION_CARRERA']],
      ['Facultad: ', datos['FACULTAD']],
      ['Proceso: ', datos['NOMBRE_PROCESO']],
      ['Promedio:', datos['PROMEDIO']],
      ['Modalidad: ', datos['MODALIDAD']],
      ['Carrera:', datos['CARRERA']],
      ['Semestre de inicio:', '2024 - A'],
      ['Merito:', f"{datos['ORDEN_MERITO_1']}"],
      ['Constancia Nro:', f"{datos['ID']} - 2024"],
  ]
